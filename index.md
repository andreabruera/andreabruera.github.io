...
Very broadly, I am interested in what goes on in the brain when we think about things in the world, and the way in which we remember them (good ol' **semantics**). I investigate brain (**electroencephalography (EEG)**, **magnetic resonance imaging (fMRI)**) and behavioural data using cutting-edge methods from machine learning, Artificial Intelligence (AI), and in particular Natural Language Processing (NLP) - (large) language models, language statistics and distributions, corpora.
